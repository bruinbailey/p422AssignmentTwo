...
passwordChecker.prototype = {
    ...
    passStr: function(password){    // counts to get a value for password strength
        var numUppers = 0,  // set variables for each counter
            numNumbers = 0,
            numSymbols = 0,
            lenDiff = password.length - 8;  // gives value to having a password longer then minimum
        for (var i = 0; i < password.length; i++){  // loops through each letter of password and adds it to appropriate counter
